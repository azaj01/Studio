interface TesslateLogoProps {
  className?: string;
  width?: number;
  height?: number;
}

export function TesslateLogo({ className, width, height }: TesslateLogoProps) {
  return (
    <svg className={className} width={width} height={height} viewBox="0 0 161.9 126.66">
      <g>
        <path
