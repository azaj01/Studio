...
Thin wrapper — canonical logic lives in orchestrator/app/seeds/marketplace_bases.py.
...
from app.seeds.marketplace_bases import seed_marketplace_bases


async def main():
    async with AsyncSessionLocal() as db:
        count = await seed_marketplace_bases(db)
        print(f"Seeded {count} new marketplace bases.")
